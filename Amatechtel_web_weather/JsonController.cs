    ...
    public class JsonController
    {
        public string GetWeather(string city)
        {
            ...
            using (var client = new WebClient())
            {
                try
                {
                    var weather_data = client.DownloadString(ApiAddr);
                    RootObject weather_response = JsonConvert.DeserializeObject<RootObject>(weather_data);
                    var temperature = weather_response.current_observation.temperature_string;
                    var wind = weather_response.current_observation.windchill_string;
                    var rain = weather_response.current_observation.precip_today_string;
